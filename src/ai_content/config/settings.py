...
class GoogleSettings(BaseSettings):
    ...
    image_model: str = "models/imagen-4.0-generate-001"  # Updated to available model
    image_fast_model: str = "models/imagen-4.0-fast-generate-001"  # Nano Banana - fast, 1024px
